...
const SideBar = () => {
  return (
    <div className="flex font-poppins">
            ...
            <li className="flex items-center justify-center mt-4">
              <Link to="/fazendo">
                <img
                  ...
                  alt="Icon Doing"
                  className="cursor-pointer"
                  style={{ width: "34px", height: "34px" }} // Dimensões específicas
                />
              </Link>
            </li>
            <li className="flex items-center justify-center mt-4">
      ...
      <div className="w-64 bg-white h-screen overflow-hidden">
        <ul className="pt-6">
          ...
          <li className="pl-6 p-4 mt-8 text-slate-800 font-medium whitespace-nowrap flex items-center"
            style={{ fontSize: "24px" }}>
            <Link to="/Tarefas">
              Início
            </Link>
          ...
          {/* Redireciona para as tarefas "Fazendo" */}
          <li className="pl-6 p-4 mt-5 text-slate-800 font-medium whitespace-nowrap flex items-center"
            style={{ fontSize: "24px" }}>
            <Link to="/fazendo">
              Em andamento
